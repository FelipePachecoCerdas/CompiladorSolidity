...
public class Semantico {
  ...
  public void evalBreakFuncion(Object b, Object symb) {
    ...
    Symbol sp2 = new Symbol(simp.sym, simp.left + 1, simp.right + 1, b.toString());
    errores.add(sp2);
  ...
  public void expresion_consumirExpresion(Object symb) {
    ...
    if (this.pilaSem.peek() instanceof RegistroSemantico_Operador) {  // a = EDX
      ...
      if (rs_do_exp_res.tipoDO.equals("ERROR") || rs_ret.tipoDato == null || rs_ret.tipoDato.equals("void")) {
        return;
      }
